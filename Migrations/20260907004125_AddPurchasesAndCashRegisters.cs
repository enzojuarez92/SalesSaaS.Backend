...
{
    /// <inheritdoc />
    public partial class AddPurchasesAndCashRegisters : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CashRegisterSessions_Warehouses_WarehouseId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CashRegisterSessionId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SupplierAccountEntries", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SupplierAccountEntries_PurchaseInvoices_PurchaseInvoiceId",
                        column: x => x.PurchaseInvoiceId,
                        principalTable: "PurchaseInvoices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SupplierAccountEntries_Suppliers_SupplierId",
                        column: x => x.SupplierId,
                        principalTable: "Suppliers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CashRegisterSessions_WarehouseId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SupplierAccountEntries_PurchaseInvoiceId",
                table: "SupplierAccountEntries",
                column: "PurchaseInvoiceId");

            migrationBuilder.CreateIndex(
                name: "IX_SupplierAccountEntries_SupplierId",
                table: "SupplierAccountEntries",
                column: "SupplierId");

            migrationBuilder.CreateIndex(
                name: "IX_Suppliers_TenantId_TaxId",
                table: "Suppliers",
