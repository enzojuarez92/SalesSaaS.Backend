...
{
    private static readonly PathString[] ExcludedPaths = ["/api/profile", "/api/auth", "/api/billing", "/api/subscription", "/api/subscriptions", "/api/tenants", "/api/settings", "/api/admin", "/swagger"];
