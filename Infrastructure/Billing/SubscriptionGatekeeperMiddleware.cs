...
{
    private static readonly PathString[] ExcludedPaths = ["/api/profile", "/api/auth", "/api/billing", "/api/subscription", "/api/subscriptions", "/api/tenants", "/api/settings", "/api/admin", "/api/superadmin", "/api/support", "/api/impersonation", "/swagger"];
